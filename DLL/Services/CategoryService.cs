...
namespace BLL.Services
{
    public class CategoryService
    {
       ...
       public List<CategoryDTO> Get()
        ...
        //other services
        public List<CategoryPerfumeDTO> GetWithPerfumes()
        {
            var data = factory.CategoryFeature().GetWithPerfumes();
            var ret=MapperConfig.GetMapper().Map<List<CategoryPerfumeDTO>>(data);
            return ret;
        }
